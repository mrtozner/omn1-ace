...
> **Note**: This document describes the internal SDK installation for development purposes. For normal usage, see the main [README.md](../../README.md) for API-based installation.
...
# Remove packages (if installed in development mode)

# OmniMemory Compression SDK

Python client library for the Omn1-ACE compression service.

> **Note**: This SDK is for internal development use. To use Omn1-ACE, interact with the REST API directly (see main [README.md](../../../README.md) for setup instructions).

## Installation (Development)

```bash
# Install from source (for development)
cd core/compression/sdk
pip install -e .
```

Or add to your project:
```bash
pip install -e /path/to/omn1-ace/core/compression/sdk
```
...
async def main():
    # Initialize client (points to your local/deployed API)
    client = OmniMemory(
        base_url="http://localhost:8000",  # Your Omn1-ACE API
